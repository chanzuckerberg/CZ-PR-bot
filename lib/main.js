...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { base_ref, base_sha, head_ref, head_sha, body } = yield (0, PullRequests_1.pullRequestDetails)(inputs.token);
            console.log({ base_ref, base_sha, head_ref, head_sha });
            const incompleteCommentTasks = yield getIncompleteCountFromComments(octokit, inputs, issueNumber);
...
function getIncompleteCountFromComments(octokit, inputs, issueNumber) {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
